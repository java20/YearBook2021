      ...
      <div class="my-page page user_profile">
					<div class="user_profile__container">
						<figure class="user_profile__card">
							<img src="${student_responses[i]["Add Image for your Profile Photo"]}" alt="${student_responses[i]["Full Name"]}"
								class="user_profile__image" />
							<figcaption class="user_profile__name">${student_responses[i]["Full Name"]}</figcaption>
						</figure>
						<figure class="user_profile__card">
							<img src="${student_responses[i+1]["Add Image for your Profile Photo"]}" alt="${student_responses[i+1]["Full Name"]}"
								class="user_profile__image" />
							<figcaption class="user_profile__name">${student_responses[i+1]["Full Name"]}</figcaption>
						</figure>
						<figure class="user_profile__card">
							<img src="${student_responses[i+2]["Add Image for your Profile Photo"]}" alt="${student_responses[i+2]["Full Name"]}"
								class="user_profile__image" />
							<figcaption class="user_profile__name">${student_responses[i+2]["Full Name"]}</figcaption>
						</figure>
						<figure class="user_profile__card">
							<img src="${student_responses[i+3]["Add Image for your Profile Photo"]}" alt="${student_responses[i+3]["Full Name"]}"
								class="user_profile__image" />
							<figcaption class="user_profile__name">${student_responses[i+3]["Full Name"]}</figcaption>
						</figure>
					</div>
				</div>
  `
